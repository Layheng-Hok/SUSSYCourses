...
INSERT INTO courseware (course_id, file_type, category, url, downloadable, chapter, courseware_order, created_at) VALUES
                                                                                                                      (1,'mp4', 'lecture', 'chapter1', FALSE, 1,1,NOW()),
                                                                                                                      (1,'pdf', 'lecture', 'intro_python.pdf', FALSE, 1,2,NOW()),
                                                                                                                      (1,'mp4', 'lecture', 'advanced_js.mp4', FALSE, 1,3,NOW()),
                                                                                                                      (2,'md', 'assignment', 'datascience_overview.md', FALSE, 1,1,NOW());
