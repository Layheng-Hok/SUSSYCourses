...
(1,'mp4', 'lecture', 'chapter1', FALSE, 1,1, null, 1, NOW()),
(1,'pdf', 'lecture', 'intro_python.pdf', FALSE, 1,2, null, 1,NOW()),
(1,'mp4', 'lecture', 'advanced_js.mp4', FALSE, 1,3, null, 1,NOW()),
(2,'md', 'assignment', 'datascience_overview.md', FALSE, 1,1, null, 1,NOW());
