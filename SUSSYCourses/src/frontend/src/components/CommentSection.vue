    ...
    <div class="comments-box">
      ...
      >
        <div class="comment-header">
          <p>
            <strong>{{ getUsername(comment.userId) || "Loading..." }}:</strong>
            {{ comment.message }}
          </p>
        ...
        <div v-if="comment.replyId" class="reply">
          <p><strong>Reply to @{{ comment.userId === comment.replyId ? getUsername(comment.userId): getUsername(comment.replyId) }}:</strong></p>
